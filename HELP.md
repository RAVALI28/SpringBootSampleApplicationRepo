...
* The original package name 'com.springlearning.springboot-realtime-jpa-app' is invalid and this project uses 'com.springlearning.springboot_realtime_jpa_app' instead.
